...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post resumes_url, params: { resume: { Title: @resume.Title, attachment: @resume.attachment, category: @resume.category, price: @resume.price, year: @resume.year } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { Title: @resume.Title, attachment: @resume.attachment, category: @resume.category, price: @resume.price, year: @resume.year } }
